...
class MedicalRecord(models.Model):
    ...
    visit_date = models.DateTimeField(
        auto_now_add=True, help_text="Date and time of the medical visit"
    )
    ...
    diagnosis_details = models.TextField(
        help_text="Detailed description of the diagnosis", blank=True, null=True
    )

    # Treatment information
    treatment = models.TextField(
        help_text="Prescribed treatment or medical intervention", blank=True, null=True
    )
    ...
    notes = models.TextField(
        help_text="Additional medical notes or observations", blank=True, null=True
    )

    # Optional follow-up date
    follow_up_date = models.DateField(
        blank=True, null=True, help_text="Recommended date for follow-up appointment"
    )
    ...
    def get_summary(self):
        ...
        return {
            ...
            "doctor": (
                self.attending_doctor.get_full_name()
                if self.attending_doctor
                else "Unknown"
            ),
        }
